...
window.SITE = {
  profile: {
    name: "Elva Wang",
    headline: "I design learning and engagement strategy, grounded in research and data-driven insights.",
    summary: "A learning designer and engagement strategist, translating research and data into experiences people can understand, participate in, and remember.",
  ...
  categories: {
    ...
    marketing: { key:"marketing", name:"Engagement Strategy",        blurb:"Positioning, programming, and operations for conferences and growth." },
  ...
  Portfolio: [
...

    {
      ...
      card:{
        desc:"An AI-integrated interactive umbrella that turns rain, touch, and movement into shared sensory stories.",
    ...
    /* ====================== MARKETING & EVENT STRATEGY ====================== */
    {
      ...
      title:"Harvard CAMLab — AMT Conference",
...

    {
      ...
      title:"AmCham China — Technology & Innovation Summit",
...

    {
      ...
      hero:{ img:"assets/ev_cover.png", contain:true },
      card:{
      ...
      problemLabel:"Research question",
      body:[
        { t:"framework", title:"Research framework", steps:["Tariffs · Subsidies · Lithium Independence","EV Export Competitiveness","Global Trade Tensions"] },
        { t:"process", items:[
          { label:"Data & Methods", points:[
        ...
        { t:"recs", title:"Recommendations", items:[
          { h:"Evidence-Based Tariffs", p:"Use antidumping measures only when supported by transparent economic evidence." },
          { h:"Distinguish Fair Competition", p:"Separate competitive low pricing from predatory pricing before applying trade remedies." },
          { h:"Secure Lithium Supply", p:"Invest in domestic and allied lithium extraction, refining, and recycling." },
          { h:"Build Supply Partnerships", p:"Develop partnerships with resource-rich countries to reduce geopolitical risk." },
          { h:"Balance Protection & Adoption", p:"Protect domestic industry without undermining affordability, consumer welfare, or decarbonization goals." }
        ]}      
      ],
